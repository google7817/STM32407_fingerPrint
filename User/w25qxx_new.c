...
{ 
    ...
    sendData = ((u8)((ReadAddr)>>16));  //发送24bit地址  
    Dev_Flash_SPISendData(&sendData,1,100);  
    sendData = ((u8)((ReadAddr)>>8));  
	Dev_Flash_SPISendData(&sendData,1,100); 
    sendData = ((u8)ReadAddr);   
	Dev_Flash_SPISendData(&sendData,1,100); 
...
void W25QXX_Write_Page(u8* pBuffer,u32 WriteAddr,u16 NumByteToWrite)
{
	...
	Dev_Flash_SPISendData(&sendData,1,100);        //发送读取命令   
    sendData = ((u8)((WriteAddr)>>16));  //发送24bit地址  
    Dev_Flash_SPISendData(&sendData,1,100);  
    sendData = ((u8)((WriteAddr)>>8));  
	Dev_Flash_SPISendData(&sendData,1,100); 
    sendData = ((u8)WriteAddr);   
	Dev_Flash_SPISendData(&sendData,1,100);   
...
{  
    ...
    sendData = ((u8)((Dst_Addr)>>16));  //发送24bit地址    
    Dev_Flash_SPISendData(&sendData,1,100);
    sendData = ((u8)((Dst_Addr)>>8)); 
	Dev_Flash_SPISendData(&sendData,1,100);
    sendData = ((u8)Dst_Addr);  
	Dev_Flash_SPISendData(&sendData,1,100);
	FLASH_SPI_CS_DIS();                             //取消片选     	      
